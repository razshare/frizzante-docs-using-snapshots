...
<Page title="Todos Example">
    ...
    <Note>
        ...
        <span>See <a href="/frizzante-docs-using-snapshots/type_definitions">type definitions</a>.</span>
    </Note>
    ...
    <Tip>
        <span>
            ...
            <a href="/frizzante-docs-using-snapshots/web_standards#form-component">Form Component</a>.
        </span>
    </Tip>
    <span>
    ...
    {#snippet footer()}
        <Footer
            previous={{ label: "Snapshots", href: "/frizzante-docs-using-snapshots/snapshots" }}
            next={{ label: "Docker", href: "/frizzante-docs-using-snapshots/docker" }}
        />
    {/snippet}
</Page>
