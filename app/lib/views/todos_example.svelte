...
<Page title="Todos Example" {dev}>
    ...
    <Note>
        ...
        <span>See <a href={base("/type_definitions", { dev })}>type definitions</a>.</span>
    </Note>
    ...
    <Tip>
        <span>
            ...
            <a href={base("/web_standards#form-component", { dev })}>Form Component</a>.
        </span>
    </Tip>
    <span>
