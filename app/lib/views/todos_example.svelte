...
<Page title="Todos Example">
    ...
    <Note>
        ...
        <span>See <a href={base("/type_definitions")}>type definitions</a>.</span>
    </Note>
    ...
    <Tip>
        <span>
            ...
            <a href={base("/web_standards#form-component")}>Form Component</a>.
        </span>
    </Tip>
    <span>
    ...
    {#snippet footer()}
        <Footer
            previous={{ label: "Snapshots", href: base("/snapshots") }}
            next={{ label: "Docker", href: base("/docker") }}
        />
    {/snippet}
</Page>
