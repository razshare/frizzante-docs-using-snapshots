import{p as C,f as H,a as P,s as e,b as y,c as I,g as v,u as _,h as G}from"./index-CQxZXpNM.js";import{C as r}from"./code.js";import{I as n}from"./inline_code.js";import{P as R,T as b,R as j,F as q}from"./right_sidebar.js";import{p as x,b as w}from"./navbar.js";const M="/frizzante-docs-using-snapshots/assets/guards_diagram_1.svg",N="/frizzante-docs-using-snapshots/assets/guards_diagram_2.svg";var A=H("<!> <span>A guard is an object that is composed of an optional name and a required handler.</span> <br/> <span>You can add guards to your routes in order to protect them.</span> <!> <span>Guards will block all incoming requests by default, you must call <!> to explicitly allow the request through.</span> <br/> <span>In this example, <!> the route will decline requests with content type <!></span> <!> <!> <span>You can compose multiple guards in order to create more advanced restrictions.</span> <!> <!> <!> <!>",1);function B(S,a){C(a,!0),R(S,{title:"Guards",get prefix(){return a.prefix},rightSidebar:t=>{j(t,{items:[{shift:0,text:"Guards"},{shift:0,text:"Composition"}]})},footer:t=>{{let i=_(()=>({label:"Server Sent Events",href:w("/server_sent_events",{prefix:a.prefix})})),s=_(()=>({label:"Views",href:w("/views",{prefix:a.prefix})}));q(t,{get previous(){return v(i)},get next(){return v(s)}})}},children:(t,i)=>{var s=A(),o=P(s);b(o,{text:"Guards"});var u=e(o,8);r(u,{lang:"go",source:`
        ...
        `});var d=e(u,2),E=e(G(d));n(E,{source:"allow()"});var l=e(d,4),c=e(G(l));n(c,{source:"GET /api/xml/data"});var T=e(c,2);n(T,{source:"application/json"});var p=e(l,2);x(p,{get src(){return M},width:"100%"});var g=e(p,2);b(g,{text:"Composition"});var h=e(g,4);r(h,{lang:"go",source:`
