import{p as z,f as p,a as d,s as e,b as a,c as E,e as f}from"./index-elLOZMZZ.js";import{i as F,d as K,h as M}from"./navbar-DCDF4cA1.js";import{C as n}from"./code-CHySw2ew.js";import{P as N,T as R,R as q,F as A}from"./right_sidebar-DSOKDO70.js";import{I as i}from"./inline_code-w6SJIKYc.js";import{K as _}from"./keyed_section-BqFj__c1.js";import{N as L}from"./note-hqMI2WFK.js";import{T as Y}from"./tip-TTQ2jHB6.js";var B=p("<span>All <!> tags are optional.</span>"),H=p("<!> <!>",1),J=p("<span>You can use the default <!> alias to access the <!> directory.</span> <!>",1),O=p("<!> <span>This will generate your type definitions in <!>.</span> <!> <!>",1),Q=p("<!> <span>It is possible, but not required, to generate TypeScript type definitions from Go structs using <a>cli plugins</a> and <!>, where T is the type you wish to generate.</span> <br/> <br/> <!> <!> <!>",1);function ie(k,j){z(j,!1),F(),N(k,{title:"Type Definitions",rightSidebar:s=>{q(s,{items:[{shift:0,text:"Type Definitions"},{shift:1,text:"Define your Go types"},{shift:1,text:"Call types.Generate[T]()"},{shift:1,text:"Generate types"}]})},footer:s=>{A(s,{previous:{label:"Cli",href:"/cli"},next:{label:"Snapshots",href:"/snapshots"}})},children:(s,W)=>{var y=Q(),h=d(y);R(h,{text:"Type Definitions"});var v=e(h,2),$=e(f(v));K($,r=>({...r}),[()=>M("/cli#plugins")]);var C=e($,2);i(C,{source:"types.Generate[T]()"});var P=e(v,6);_(P,{key:"1",description:"Define your Go types.",children:(r,T)=>{var t=H(),o=d(t);n(o,{lang:"go",source:`
                package welcome
