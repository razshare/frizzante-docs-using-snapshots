import{f as he,a as me,s as e,b as ve,e as r}from"./index-elLOZMZZ.js";import"./navbar-DCDF4cA1.js";import{C as t}from"./code-CHySw2ew.js";import{P as ue,T as o,R as fe,F as ge}from"./right_sidebar-DSOKDO70.js";import{I as n}from"./inline_code-w6SJIKYc.js";var we=he(`<!> <span>You can use <!> and <!> in order to make your hyperlinks and forms adapt to the client’s browser capabilities and/or the server’s rendering
        ...
        `});var k=e(y,2),S=e(r(k));n(S,{source:"<form>"});var Z=e(S,2);n(Z,{source:"/process"});var x=e(k,4),F=e(r(x));n(F,{source:"<form>"});var ee=e(F,4);n(ee,{source:"/process"});var I=e(x,4),ne=e(r(I));n(ne,{source:"view.RenderModeServer"});var C=e(I,2);t(C,{lang:"go",source:`
            package welcome
        ...
        `});var R=e(C,4);t(R,{lang:"html",source:`
            <form action="/process">
                <input type="text" name="name" />
                <button type="submit">Submit</button>
            </form>
        `});var $=e(R,2),re=e(r($));n(re,{source:"view.RenderModeFull"});var W=e($,2);t(W,{lang:"html",source:`
            <form action="/process" onsubmit="onsubmit(event)">
                <input type="text" name="name" />
                <button type="submit">Submit</button>
            </form>
        `});var z=e(W,2),D=e(r(z));n(D,{source:"onsubmit(event)"});var te=e(D,2);n(te,{source:"/process"});var L=e(z,2);o(L,{text:"Link Component"});var T=e(L,2),ae=e(r(T));n(ae,{source:"<Link>"});var M=e(T,4),oe=e(r(M));n(oe,{source:"<a>"});var V=e(M,6);t(V,{lang:"shell",source:"frizzante -glinks"});var A=e(V,2),se=e(r(A));n(se,{source:"<Link>"});var J=e(A,4),P=e(r(J));n(P,{source:"pending"});var j=e(P,2);n(j,{source:"error"});var ie=e(j,2);n(ie,{source:"children"});var G=e(J,2);t(G,{lang:"svelte",source:`
            <script lang="ts">
        ...
        `}),ve(a,s)},$$slots:{rightSidebar:!0,footer:!0,default:!0}})}export{Ce as default};
