import{f as S,a as x,s as e,b as C,e as h}from"./index-m7pZRt4W.js";import{n as v}from"./navbar-CP7DJdaE.js";import{C as a}from"./code-BNWQWXxF.js";import{I as s}from"./inline_code-DCaNBFnV.js";import{P as E,T as f,R as T,F as z}from"./right_sidebar-BoxgKQGW.js";const H="/frizzante-docs-using-snapshots/assets/guards_diagram_1-8XvtXsMA.svg",P="/frizzante-docs-using-snapshots/assets/guards_diagram_2-CBpLkatL.svg";var y=S("<!> <span>A guard is an object that is composed of an optional name and a required handler.</span> <br/> <span>You can add guards to your routes in order to protect them.</span> <!> <span>Guards will block all incoming requests by default, you must call <!> to explicitly allow the request through.</span> <br/> <span>In this example, <!> the route will decline requests with content type <!></span> <!> <!> <span>You can compose multiple guards in order to create more advanced restrictions.</span> <!> <!> <!> <!>",1);function N(_){E(_,{title:"Guards",rightSidebar:t=>{T(t,{items:[{shift:0,text:"Guards"},{shift:0,text:"Composition"}]})},footer:t=>{z(t,{previous:{label:"Server Sent Events",href:"/server_sent_events"},next:{label:"Views",href:"/views"}})},children:(t,j)=>{var r=y(),n=x(r);f(n,{text:"Guards"});var o=e(n,8);a(o,{lang:"go",source:`
