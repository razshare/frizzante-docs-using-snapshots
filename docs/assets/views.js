import{p as $e,f as d,a as c,s as e,b as n,c as Ve,g as pe,u as ce,h as s,d as Pe,e as P}from"./index-B3gjky_M.js";import{a as Me,h as Te,b as M,c as ve}from"./navbar.js";import{C as ke}from"./caution.js";import{C as l}from"./code.js";import{F as Ce}from"./file_tree.js";import{P as Fe,T as h,R as We,F as Ne}from"./right_sidebar.js";import{I as r}from"./inline_code.js";import{K as T}from"./keyed_section.js";import{N as k}from"./note.js";import{T as C}from"./tip.js";var Ee=d("<!> <!>",1),Ie=d(`<span>These views are being imported asynchronously in order to split them in different bundles, however you can
        ...
        `});var H=e(D,2);k(H,{children:(a,u)=>{var o=Ie(),t=e(c(o),2);l(t,{lang:"go",source:`
                import Welcome from '$lib/views/welcome.svelte'
                import Profile from '$lib/views/profile.svelte'
                export const views = {
            ...
            `}),n(a,o)}});var L=e(H,2);k(L,{children:(a,u)=>{var o=Ue(),t=c(o),p=e(s(t));r(p,{source:"app/exports.server.ts"});var i=e(p,2);r(i,{source:"app/exports.client.ts"}),n(a,o)}});var Z=e(L,2);h(Z,{text:"Send Views"});var z=e(Z,2),fe=e(s(z));r(fe,{source:"send.View()"});var G=e(z,2);l(G,{lang:"go",source:`
            package welcome
        ...
        `});var ne=e(te,2);k(ne,{children:(a,u)=>{var o=Ae();n(a,o)}});var se=e(ne,2);h(se,{text:"Render Modes"});var ae=e(se,2),ie=e(s(ae));r(ie,{source:"RenderMode"});var ye=e(ie,2);r(ye,{source:"View"});var le=e(ae,6);T(le,{key:"1",description:"RenderModeFull",children:(a,u)=>{var o=Je(),t=c(o),p=e(s(t));r(p,{source:"RenderModeFull"});var i=e(t,6);l(i,{lang:"go",source:`
            package welcome
        ...
        `}),n(a,o)},$$slots:{default:!0}});var de=e(le,2);T(de,{key:"2",description:"RenderModeServer",children:(a,u)=>{var o=Ye(),t=c(o),p=e(s(t));r(p,{source:"RenderModeServer"});var i=e(t,6);l(i,{lang:"go",source:`
            package welcome
        ...
        `});var f=e(i,2);C(f,{children:(S,_)=>{var g=qe(),v=e(c(g));r(v,{source:"RenderModeServer"});var m=e(v,2);r(m,{source:"<svelte:head>"}),n(S,g)}}),n(a,o)},$$slots:{default:!0}});var xe=e(de,2);T(xe,{key:"3",description:"RenderModeClient",noLink:!0,children:(a,u)=>{var o=Ze(),t=c(o),p=e(s(t));r(p,{source:"RenderModeClient"});var i=e(t,2);l(i,{lang:"go",source:`
            package welcome
        ...
        `});var f=e(i,2);C(f,{children:(_,g)=>{var v=De(),m=e(c(v),4),w=e(s(m));Me(w,b=>({...b}),[()=>Te(M("/web_standards",{prefix:x.prefix}))]),n(_,v)}});var S=e(f,2);C(S,{children:(_,g)=>{var v=Le(),m=e(c(v));r(m,{source:"RenderModeFull"});var w=e(m,2);r(w,{source:"RenderModeServer"});var b=e(w,2);r(b,{source:"FRIZZANTE_JS_RUNTIME_LIMIT"});var y=e(b,2);l(y,{lang:"shell",source:"FRIZZANTE_JS_RUNTIME_LIMIT=3 ./app"});var $=e(y,2);ke($,{children:(Re,je)=>{var Se=He();n(Re,Se)}}),n(_,v)}}),n(a,o)},$$slots:{default:!0}}),n(R,V)},$$slots:{rightSidebar:!0,footer:!0,default:!0}}),Ve()}export{ar as default};
