import{p as ke,f as Se,a as xe,s as e,i as Fe,b as Ie,c as Ce,g as Z,u as ee,h as n}from"./index-CQxZXpNM.js";import{b as p,e as Re}from"./navbar.js";import{C as t}from"./code.js";import{P as We,T as s,R as ze,F as De}from"./right_sidebar.js";import{I as r}from"./inline_code.js";var Le=Se(`<!> <span>You can use <!> and <!> in order to make your hyperlinks and forms adapt to the client’s browser capabilities and/or the server’s rendering
        ...
        `});var C=e(I,2),R=e(n(C));r(R,{source:"<form>"});var ie=e(R,2);r(ie,{source:"/process"});var W=e(C,4),z=e(n(W));r(z,{source:"<form>"});var pe=e(z,4);r(pe,{source:"/process"});var D=e(W,4),de=e(n(D));r(de,{source:"view.RenderModeServer"});var L=e(D,2);t(L,{lang:"go",source:`
            package welcome
        ...
        `}),Fe(ye=>Re(w,"href",ye),[()=>p("/some-other-page",{prefix:a.prefix})]),Ie(o,i)},$$slots:{rightSidebar:!0,footer:!0,default:!0}}),Ce()}export{je as default};
