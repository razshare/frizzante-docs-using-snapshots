import{p as C,f as _,a as E,s as e,t as T,b,c as I,g as M,u as R,h as y}from"./index-B3gjky_M.js";import{b as k,f as A}from"./navbar.js";import{C as o}from"./code.js";import{P as G,T as r,R as S,F as V}from"./right_sidebar.js";import{I as x}from"./inline_code.js";import{N as j}from"./note.js";var D=_("<span>Your implementation may vary.</span> <br/> <span>This implementation doesn’t directly invoke the next hook, instead it sets a flag.</span> <br/> <span>This should keep your stack size smaller and thus more readable.</span>",1),N=_(`<!> <!> <span>Frizzante intentionally uses guards instead of middleware.</span> <br/> <span>Middleware have some limitations.</span> <br/> <ul><li>All middleware handles must be invoked for each request</li> <li>Some middleware may contain path-checking logic while others may not, which introduces ambiguity and more
