import{f as w,a as _,s as e,b as f,e as z}from"./index-DcfPEVm2.js";import"./navbar.js";import{C as t}from"./code.js";import{P as H,T as r,R as F,F as P}from"./right_sidebar.js";import{I as g}from"./inline_code.js";import{N as q}from"./note.js";var C=w("<span>Your implementation may vary.</span> <br/> <span>This implementation doesn’t directly invoke the next hook, instead it sets a flag.</span> <br/> <span>This should keep your stack size smaller and thus more readable.</span>",1),E=w(`<!> <!> <span>Frizzante intentionally uses guards instead of middleware.</span> <br/> <span>Middleware have some limitations.</span> <br/> <ul><li>All middleware handles must be invoked for each request</li> <li>Some middleware may contain path-checking logic while others may not, which introduces ambiguity and more
            details to remember as a developer</li> <li>Managing middleware execution order across different routes is complex</li></ul> <br/> <span>While guards have some advantages.</span> <br/> <ul><li><strong>Efficient</strong> <span>-</span> <span>each route has a defined slice of guards and only those guards will execute each time the route is
                ...
                guards slice</span></li></ul> <span>For more details see the <a href="/frizzante-docs-using-snapshots/guards">guards page</a>.</span> <!> <span>If you really want middleware-like behavior, you can easily implement it in your own project.</span> <!> <!> <!> <!> <!> <!> <span>Yes you can, as long as Vite supports your framework.</span> <br/> <span>All you need to do is configure your <!> and <!> to render your framework.</span> <br/> <span>You can find a Vue3 example <a target="_blank" href="https://github.com/razshare/frizzante-example-vue3">here</a>.</span>`,1);function D(v){H(v,{title:"Faq",rightSidebar:a=>{F(a,{items:[{shift:0,text:"Faq"},{shift:0,text:"Why doesn’t Frizzante have middleware?"},{shift:1,text:"Middleware Implementation"},{shift:1,text:"Middleware Usage"},{shift:0,text:"Can I use Frizzante with other frontend frameworks?"}]})},footer:a=>{P(a,{previous:{label:"Contributing",href:"/frizzante-docs-using-snapshots/contributing"}})},children:(a,M)=>{var s=E(),o=_(s);r(o,{text:"Faq"});var n=e(o,2);r(n,{type:"h3",text:"Why doesn’t Frizzante have middleware?"});var i=e(n,22);r(i,{type:"h5",text:"Middleware Implementation"});var l=e(i,4);t(l,{lang:"go",source:`
            package middlewares
        ...
        `});var m=e(p,2);r(m,{type:"h3",text:"Can I use Frizzante with other frontend frameworks?"});var b=e(m,6),h=e(z(b));g(h,{source:"app/app.client.ts"});var y=e(h,2);g(y,{source:"app/app.server.ts"}),f(a,s)},$$slots:{rightSidebar:!0,footer:!0,default:!0}})}export{D as default};
