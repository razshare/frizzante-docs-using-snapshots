import{f as b,a as F,s as t,b as m}from"./index-elLOZMZZ.js";import"./navbar-DCDF4cA1.js";import{C as o}from"./code-CHySw2ew.js";import{P as S,T as e,R as w,F as z}from"./right_sidebar-DSOKDO70.js";import{T as M}from"./tip-TTQ2jHB6.js";var E=b("<span>If you don’t have direct access to it you will need to fork your own frizzante repository.</span> <br/> <span>Then when you’re done with your changes you will need to submit a pull request.</span>",1),P=b(`<!> <span>This document describes the full process of setting up a fully working local development environment and
        ...
        package.</span> <br/> <span>This type of code should be avoided</span> <!> <span>and be instead converted into</span> <!> <!> <span>When you’re done with your changes you can submit a pull request in order to implement them into frizzante.</span>`,1);function L(v){S(v,{title:"Contributing",rightSidebar:r=>{w(r,{items:[{shift:0,text:"Contributing"},{shift:0,text:"Clone Repository"},{shift:0,text:"Create Branch"},{shift:0,text:"Coding Standards"},{shift:1,text:"Export Everything"},{shift:1,text:"Data & Logic"},{shift:0,text:"Pull Requests"}]})},footer:r=>{z(r,{previous:{label:"Issues",href:"/issues"},next:{label:"Faq",href:"/faq"}})},children:(r,R)=>{var n=P(),a=F(n);e(a,{text:"Contributing"});var s=t(a,4);e(s,{text:"Clone Repository"});var i=t(s,4);o(i,{source:"git clone https://github.com/razshare/frizzante"});var u=t(i,2);M(u,{children:(_,$)=>{var C=E();m(_,C)}});var d=t(u,2);e(d,{text:"Create Branch"});var l=t(d,4);o(l,{source:"git checkout -b feature/some-feature"});var p=t(l,2);e(p,{text:"Coding Standards"});var c=t(p,4);e(c,{type:"h3",text:"Export Everything"});var f=t(c,4);o(f,{lang:"go",source:`
